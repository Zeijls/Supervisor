...
const AcNewContractContactTable = ({
  store,
  current_contact,
  is_loading,
  handlePagination,
  ...
  const getSearchTitleClassNames = useMemo(() => {
    ...
    if (search_image) {
      return (
        <div className={getNoSearchResultClassNames}>
          ...
          <h3 className={getSearchTitleClassNames}>
...
export default AcNewContractContactTable;
